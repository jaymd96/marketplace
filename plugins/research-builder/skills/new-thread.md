---
name: new-thread
description: "Create a new idea thread to track a line of reasoning. Use when a new idea worth tracking emerges, or the user says 'let us track this idea', 'new thread', 'this is a separate line of thinking', or 'start a thread for [topic]'."
---
